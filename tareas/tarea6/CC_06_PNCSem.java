/**
 * Sexta tarea evaluable - Almacén de varios datos con semáforos
 * 
 * Este ejercicio es una variación del problema anterior. En esta ocasión, el almacén a implemen-
 * tar tiene una capacidad de hasta N productos, lo que permite a los productores seguir trabajando
 * aunque los consumidores se vuelvan, momentáneamente, lentos.
 * 
